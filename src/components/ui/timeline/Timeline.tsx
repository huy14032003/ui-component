...
const Timeline = React.forwardRef<HTMLUListElement, TimelineProps>(
    ({ className, children, direction = 'vertical', itemWidth, itemHeight, ...props }, ref) => {
            ...
            >
                {items.map((child, index) => {
                    return React.cloneElement(child as React.ReactElement<any>, {
                        ...
                        direction,
                        width: (child as React.ReactElement<any>).props.width ?? itemWidth,
                        height: (child as React.ReactElement<any>).props.height ?? itemHeight,
                    });
                })}
            </ul>
        );
